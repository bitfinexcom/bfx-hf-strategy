 ...
 * {@link module:bfx-hf-strategy.defineStrategy|defineStrategy} to obtain a
 * {@link module:bfx-hf-strategy.StrategyState|StrategyState} object which can
 * then be used with either
 * {@link module:bfx-hf-backtest|bfx-hf-backtest} for backtesting on historical
 * data, or {@link module:bfx-hf-strategy-exec|bfx-hf-strategy-exec} for live
 * execution.
 *
 * @typedef {object} module:bfx-hf-strategy.StrategyDefinition
